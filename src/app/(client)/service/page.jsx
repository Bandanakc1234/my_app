      ...
      <div className="lfooter bg-white md:p-10">
        ...
        <div className="topbuttom flex flex-col gap-5 pb-7">
          <div className="top flex-col-3 justify-between lg:flex lg:justify-between">
            <div className="topfirst bg-white md:w-96 w-52 rounded-md p-2 flex flex-col justify-center shadow-xl hover:bg-blue-200 m-auto gap-5 mb-10 lg:m-10" data-aos="zoom-in" data-aos-duration="000">
