...
import VerifyEmail from '../verifyEmail/[token]/page';
    ...
    return (
        <div>
            ...
            <div className='log_in flex justify-center text-center items-center font-serif '>
                <div className='circle lg:border-8 border-4 bg-blue-200 opacity-80 rounded-full lg:p-20 md:p-10 p-5' onSubmit={handleSubmit}>
                    ...
                    <label htmlFor="email" className='m-2'>
                        ...
                        <input type="text" name="email" id="email" placeholder="Enter your email.." onChange={handleChange} className=' rounded-md py-1.5 w-full placeholder:p-1 p-4 bg-white' value={email} />
                    </label>
                    <br />
                    <label htmlFor="password" className='m-2'>
                        ...
                        <input type="password" name="password" id="password" placeholder="Enter your password..." onChange={handleChange} className=' rounded-md py-1.5 w-full bg-white placeholder:p-1 p-4' value={password} />
                    </label>
                    <br />
