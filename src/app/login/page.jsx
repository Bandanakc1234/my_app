...
const login = () => {
    return (
        <div className='log_in  flex justify-center text-center items-center'>
            <div className='circle lg:border-8 border-4 border-gray-600  bg-black opacity-70 rounded-full lg:p-20 md:p-10 p-5'>
                ...
                <label className='m-2'>
                    ...
                    <input type="text" name="firstName" placeholder="Enter username or email.." className='bg-transparent border-2 rounded-md h-10 md:w-80 w-50 px-4' />
                </label>
                <br />
                <label className='m-2'>
                    ...
                    <input type="text" name="password" placeholder="Enter password here..." className='bg-transparent border-2 rounded-md h-10 md:w-80 w-50 px-4' />
                </label>
                <br />
