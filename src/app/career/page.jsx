    ...
    return (
        <div className='md:px-16 bg-blue-200 px-6 font-serif'>
            ...
            <div className='bg-white p-10'>
                ...
                <div className='md:w-96 h-auto rounded-lg flex flex-col text-center pt-12 mt-10 shadow-xl hover:bg-blue-200 lg:mb-24 mb-14' data-aos="fade-up" data-aos-duration="2000">
